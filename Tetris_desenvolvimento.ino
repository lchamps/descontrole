...
//converter a função do joystick para receber comandos via mqtt
//inspeção inicial do código em 20201122 inclusão do wifi manager
...
#define TARGET_FRAME_TIME 255  //25  // Desired update rate, though if too many leds it will just run as fast as it can!
#define INITIAL_DROP_FRAMES 150 //20  // Start of game block drop delay in frames
//MQTT client
IPAddress server(192, 168, 1, 67);  // raspi server
WiFiClient espClient;
PubSubClient client(espClient);

//mqtt virtual bottons
String pload = "1"; // to receive mqtt payload
int button_rotate = 0;
int button_left = 0;
int button_right = 0;
int button_down = 0;
...
const uint8_t TetrisIData[] = { // Frame 1
  B8_3BIT(00000000),
  B8_3BIT(00000000),
  B8_3BIT(00000000),
  B8_3BIT(11110000),
...
const uint8_t TetrisIMask[] = { // Frame 1
  B8_1BIT(00000000),
  B8_1BIT(00000000),
  B8_1BIT(00000000),
  B8_1BIT(11110000),
...
const uint8_t TetrisJData[] = { // Frame 1
  B8_3BIT(00000000),
  B8_3BIT(00000000),
  B8_3BIT(22200000),
  B8_3BIT(00200000),
...
const uint8_t TetrisJMask[] = { // Frame 1
  B8_1BIT(00000000),
  B8_1BIT(00000000),
  B8_1BIT(11100000),
  B8_1BIT(00100000),
...
const uint8_t TetrisLData[] = { // Frame 1
  B8_3BIT(00000000),
  B8_3BIT(00000000),
  B8_3BIT(33300000),
  B8_3BIT(30000000),
...
const uint8_t TetrisLMask[] = { // Frame 1
  B8_1BIT(00000000),
  B8_1BIT(00000000),
  B8_1BIT(11100000),
  B8_1BIT(10000000),
...
const uint8_t TetrisOData[] = { // Frame 1
  B8_3BIT(00000000),
  B8_3BIT(00000000),
  B8_3BIT(44000000),
  B8_3BIT(44000000),
...
const uint8_t TetrisOMask[] = { // Frame 1
  B8_1BIT(00000000),
  B8_1BIT(00000000),
  B8_1BIT(11000000),
  B8_1BIT(11000000),
...
const uint8_t TetrisSData[] = { // Frame 1
  B8_3BIT(00000000),
  B8_3BIT(00000000),
  B8_3BIT(05500000),
  B8_3BIT(55000000),
...
const uint8_t TetrisSMask[] = { // Frame 1
  B8_1BIT(00000000),
  B8_1BIT(00000000),
  B8_1BIT(01100000),
  B8_1BIT(11000000),
...
const uint8_t TetrisTData[] = { // Frame 1
  B8_3BIT(00000000),
  B8_3BIT(00000000),
  B8_3BIT(66600000),
  B8_3BIT(06000000),
...
const uint8_t TetrisTMask[] = { // Frame 1
  B8_1BIT(00000000),
  B8_1BIT(00000000),
  B8_1BIT(11100000),
  B8_1BIT(01000000),
...
const uint8_t TetrisZData[] = { // Frame 1
  B8_3BIT(00000000),
  B8_3BIT(00000000),
  B8_3BIT(77000000),
  B8_3BIT(07700000),
...
const uint8_t TetrisZMask[] = { // Frame 1
  B8_1BIT(00000000),
  B8_1BIT(00000000),
  B8_1BIT(11000000),
  B8_1BIT(01100000),
...
/*
this is ancient code for joystick control
...
void callback(char *topic, byte *payload, unsigned int length)
{
  ...
  if (strcmp(topic, "ws_rot") == 0)
  {
    button_rotate = pload.toInt();
  }
  if (strcmp(topic, "ws_lef") == 0)
  {
    button_left = pload.toInt();
    //Serial.println("topico ws_lef = "+pload);
  }
  if (strcmp(topic, "ws_rig") == 0)
  {
    button_right = pload.toInt();

    //Serial.println("topico ws_set_mode");
  }
  if (strcmp(topic, "ws_dow") == 0)
  {
    button_down = pload.toInt();
...
void reconnect()
{
  ...
  while (!client.connected())
  {
    ...
    // Attempt to connect
    if (client.connect("tetris_ws2812"))
    {
      //Serial.println("connected");
      // Once connected, publish an announcement...
      client.publish("testTopic", "hello world");
      // ... and resubscribe
      client.subscribe("ws_rot");
      client.subscribe("ws_lef");
      client.subscribe("ws_rig");
      client.subscribe("ws_dow");
    }
    else
    {
...
void setup()
{
  ...
  */
  ...
  sprintf((char*) AttractMsg, "%sTETRIS%sPLACAR %u%sTOP %u%sPRESSIONE PARA INICIAR%s", BlankMsg, BlankMsg, LastScore, BlankMsg, (int) HighScore, BlankMsg, BlankMsg);
...
#define PLASMA_Y_FACTOR 24
    ...
    if (AttractMode)
    {
      ...
      if ((button_rotate == 1) || (button_left == 1) || (button_right == 1) || (button_down == 1))
      {
        /*
    ...
    else
    {
      ...
      else
      {
        if (CurrentBlock.GetXChange() >= 0) // We have a current block
        {
          ...
          if (button_left == 1 && (!(CurrentBlock.GetFlags() &SPRITE_EDGE_X_MIN)))
          {
          ...
          else if ((button_right == 1) && (!(CurrentBlock.GetFlags() &SPRITE_EDGE_X_MAX)))
          {
            button_right = 0;
            CurrentBlock.m_X++;
            Sprites.DetectCollisions(&CurrentBlock);
